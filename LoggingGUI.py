...
class FormUi:
    ...
    def __init__(self, frame):
        ...
        self.combobox.grid(column=1, row=0, sticky=(W, E)) # type: ignore
        # Create a text field to enter a message
        self.message = tk.StringVar()
        ttk.Label(self.frame, text='Message:').grid(column=0, row=1, sticky=W)
        ttk.Entry(self.frame, textvariable=self.message, width=25).grid(column=1, row=1, sticky=(W, E)) # type: ignore
